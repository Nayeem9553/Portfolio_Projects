--In this sql script i tried to get insightfull fate out of the most populat covid data set from here: https://github.com/AlexTheAnalyst/PortfolioProjects/blob/main/CovidDeaths.xlsx
